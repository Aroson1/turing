...
*/
export default function JokerTextChat() {
    ...
    async function runChat() {
        ...
        const joker_prompt = PromptTemplate.fromTemplate(
            JOKER_PROMPT
        );

        const output_parser = new StringOutputParser();
        const joker = joker_prompt.pipe(llm).pipe(output_parser);
        ...
        try {
            ...
            const result = await joker.invoke({"query": input, "chat_history": totalHistory});
